...
const TYPE = [
  ...
  { cls: "text-display", name: "display · 44px", use: "Marketing hero only" },
];
...
export function DesignSystem() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-12 px-4 py-10 sm:px-6">
      ...
      <Section title="Type" blurb="Five sizes. Weight and colour carry hierarchy within a size; a new size is a design-system change, not a page change.">
